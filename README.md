...
## Program Schematic
In order to finish the exercise, the Tasks are done by implementing the upcoming schematic of the program.
<img src="data/program_schematic_concurrent_traffic_simulation.png">
Thereby the blue highlighted rectangles are the parts of the program that need to be implemented in the final project. Also, the green and red point-dotted lines are needed to be implemented. The green lines describe the call of the functions, whereas the red lines describe the communication flow between functions and, in order to do so, the communation between threads.   
